...
rm -f $HOME/.zshrc  # Remove .zshrc generated by GitHub Codespaces

if [ -e /usr/share/doc/git/contrib/diff-highlight/diff-highlight -a ! -x /usr/share/doc/git/contrib/diff-highlight/diff-highlight ]; then
